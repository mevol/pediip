...
#        ]
    for slice in random_pick:
        temp_stack1 = volume[(slice + 1) * int((length) / (slices_per_axis + 1)), :, :]
...
#        ]
    for slice in random_pick:
        temp_stack2 = volume[:, (slice + 1) * int((length) / (slices_per_axis + 1)), :]
...
#        ]
    for slice in random_pick:
        temp_stack3 = volume[:, :, (slice + 1) * int((length) / (slices_per_axis + 1))]
